...
Elija la versión que desea utilizar. Se recomienda seleccionar la opción "Up to Next Major Version" y especificar `3.0.0` como el límite inferior. Luego haga clic en "Next".
