...
Wählen Sie die Version aus, die Sie verwenden möchten. Es wird empfohlen, die Option "Bis zur nächsten Hauptversion" auszuwählen und `3.0.0` als Untergrenze anzugeben. Klicken Sie dann auf "Weiter".
