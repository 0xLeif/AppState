...
Выберите версию, которую вы хотите использовать. Рекомендуется выбрать опцию «До следующей основной версии» и указать `3.0.0` в качестве нижней границы. Затем нажмите «Далее».
