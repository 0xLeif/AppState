...
@propertyWrapper public struct SQLiteValue<Value: SQLiteInitializable> {
    #if !os(Linux) && !os(Windows)
    ...
    private let keyPath: KeyPath<Application, Application.SQLiteValue<Value>>
     ...
     */
    public init(
        _ keyPath: KeyPath<Application, Application.SQLiteValue<Value>>,
...
#if !os(Linux) && !os(Windows)
extension SQLiteValue: DynamicProperty { }
#endif
