...
- `application` — provides the dependency system (`Dependency<ModelContainer>`, `Application.dependency`), `Scope`, observation hooks, and logging that this module builds on.
